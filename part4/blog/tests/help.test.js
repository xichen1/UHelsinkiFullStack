...
const count = require('../utils/list_helper').count
const largest = require('../utils/list_helper').largest
...
//         const blogs = []
//         expect(count(blogs)).toBe(0)
//     })

//     test('when list has only one blog equals the likes of that', () => {
//         const result = count([blogs[0]])
//         expect(result).toBe(7)
//     })

//     test('of a bigger list is calculated right', () => {
//         // const blog = []
//         const result = count(blogs)
